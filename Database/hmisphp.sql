...
-- Ngày hoàn thiện 1/11/2023
-- Ngày nhóm nâng cấp hệ thông 4/11/2023
-- Host: 127.0.0.1
...
(1, 'ZNXI4', 'John Doe', '12 900 Los Angeles', '35', 'Malaria', 'RAV6C', '<ul><li>Combination of atovaquone and proguanil (Malarone)</li><li>Quinine sulfate (Qualaquin) with doxycycline (Vibramycin, Monodox, others)</li><li>Mefloquine.</li><li>Primaquine phosphate.</li></ul>', '2023-04-11 15:03:05.9839'),
...
(1, 'Kenyatta National Hospital', '2023-01-11', 'Mart Developers', '9KXPM', 'Success');
...
(2, '8KQWD', 'Martin Mbithi', 'RAV6C', 'John Doe', 'Malaria', '2023-04-11 08:50:10.649889', 'Successful'),
